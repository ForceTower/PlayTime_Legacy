...
import com.forcetower.playtime.di.component.DaggerPlayComponent;
...
public class PlayInjector {
    ...
    public static void init(PlayApplication application) {
        DaggerPlayComponent.builder().application(application).build().inject(application);
