...
public class SeriesRepository {
    ...
    @Inject
    public SeriesRepository(PlayDatabase database, TMDbService tmdbService, AppExecutors executors) {
    ...
    public LiveData<Resource<List<Genre>>> loadSeriesGenres() {
        return new NetworkBoundResource<List<Genre>, GenreResponse> (executors) {
            ...
            protected void saveCallResult(@NonNull GenreResponse item) {
                Timber.d("Series Genres: " + item.getGenres());
            ...
            protected LiveData<ApiResponse<GenreResponse>> createCall() {
                return tmdbService.getSeriesGenres();
            }
        }.asLiveData();
    }
}
