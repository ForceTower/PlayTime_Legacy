...
public class FadeEdgeLayout extends FrameLayout {
    ...
    private static int[] FADE_COLORS = new int[]{Color.TRANSPARENT, Color.WHITE};
    private static int[] FADE_COLORS_REVERSE = new int[]{Color.WHITE, Color.TRANSPARENT};
    ...
    public FadeEdgeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FadeEdgeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.FadeEdgeLayout, defStyleAttr, 0);
            int flags = arr.getInt(R.styleable.FadeEdgeLayout_fadeEdges, 0);
            ...
            gradientSizeTop = arr.getDimensionPixelSize(R.styleable.FadeEdgeLayout_fadeSizeTop, defaultSize);
            gradientSizeBottom = arr.getDimensionPixelSize(R.styleable.FadeEdgeLayout_fadeSizeBottom, defaultSize);
            gradientSizeLeft = arr.getDimensionPixelSize(R.styleable.FadeEdgeLayout_fadeSizeStart, defaultSize);
            gradientSizeRight = arr.getDimensionPixelSize(R.styleable.FadeEdgeLayout_fadeSizeEnd, defaultSize);

            int colorStart = arr.getColor(R.styleable.FadeEdgeLayout_fadeColorStart, Color.BLACK);
            int colorEnd   = arr.getColor(R.styleable.FadeEdgeLayout_fadeColorEnd, Color.TRANSPARENT);

            FADE_COLORS = new int[] {colorStart, colorEnd};
            FADE_COLORS_REVERSE = new int[] {colorEnd, colorStart};
